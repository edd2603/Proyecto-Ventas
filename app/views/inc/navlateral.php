...
<!-- Inclusión de JS de Bootstrap y sus dependencias (Opcional, para componentes interactivos) -->
		...
		<nav class="full-width">
			...
			<?php if ($_SESSION['rol'] === 'Administrador'): ?>
				...
				<li class="full-width">
					...
					<ul class="full-width menu-principal sub-menu-options">
						<li class="full-width">
						   <form action="<?php echo APP_URL; ?>app/views/inc/exportSalesToExcel.php" method="post" class="p-3">
							    ...
							    <div class="form-group">
							        <button type="submit" class="btn btn-primary">Descargar Ventas</button>
							    </div>
							</form>
...
<!-- 
			...
			<?php endif; ?>
			                <!-- Fin del código de administrador -->

                <li class="full-width divider-menu-h"></li>

                <!-- Opción de Ventas visible para todos los usuarios -->
                <li class="full-width">
                    <a href="#" class="full-width btn-subMenu">
                        <div class="navLateral-body-cl">
